...
class AnimaisTestCase(LiveServerTestCase):
    ...
    def setUp(self):
        self.browser = webdriver.Chrome('/mnt/c/Users/João Mata/Desktop/dev/django-tdd-alura/chromedriver.exe')
    ...
    def test_buscando_um_novo_animal(self):
        ...
        self.assertEqual(buscar_animal_input.get_attribute('placeholder'), 'Exemplo: leao')
